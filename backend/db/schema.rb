...
ActiveRecord::Schema[7.0].define(version: 2023_05_14_150507) do
  ...
  create_table "gyms", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.integer "number_of_sections", default: 1, null: false
  ...
  create_table "routes", force: :cascade do |t|
    ...
    t.integer "section_number", default: 1, null: false
